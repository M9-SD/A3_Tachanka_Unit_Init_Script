...
_EH_handleDmg = _tachanka addEventHandler['HandleDamage', { 
    ...
    if (_armorHP_pre > 0) then { 
        ...
        if (_selection in ['head']) then { 
            ...
            [_armorHitPFX,(selectRandom["ImpactSparksSabot2"])] remoteExec ['setParticleClass'];; 
    ...
    if (_breakArmor && (!(_unit getVariable['armorBroken', false]))) then { 
        ...
        if (_selection in ['head']) then { 
            ...
            [_armorHitPFX3,"FireSparksSmall3"] remoteExec ['setParticleClass'];; 
            ...
            [_armorHitPFX2,selectRandom["FireSparksSmall", "FireSparksSmall1", "FireSparksSmall2"]] remoteExec ['setParticleClass'];; 
